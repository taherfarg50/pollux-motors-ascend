...
const SimpleNavbar: React.FC = () => {
  ...
  return (
    <>
      {/* Top Bar - Force Visible */}
      <div className="top-bar w-full bg-blue-600 text-white py-2 text-sm">
      ...
      {/* Main Navbar - Force Visible Always */}
      <nav className="navbar-container w-full bg-black text-white border-b border-gray-700 sticky top-0">
        <div className="max-w-7xl mx-auto px-4">
          <div className="force-flex-visible flex items-center justify-between h-16">
            
            {/* Logo - Always Visible */}
            <div className="force-flex-visible flex items-center">
            ...
            <div className="force-desktop-nav hidden md:flex items-center space-x-6">
              {navItems.map((item) => {
            ...
            <div className="force-flex-visible flex items-center space-x-3">
              ...
              <Link
                to="/chat"
                className="p-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white relative"
                title="AI Assistant"
              >
        ...
        {isMobileMenuOpen && (
          <div className="force-mobile-visible md:hidden bg-gray-900 border-t border-gray-700">
            <div className="px-4 py-6 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 mt-6 pt-4 border-t border-gray-700">
                <Link
                  to="/profile"
                  className="flex items-center justify-center space-x-2 px-4 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
